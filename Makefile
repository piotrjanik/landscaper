...
CODE_DIRS := $(REPO_ROOT)/cmd/... $(REPO_ROOT)/pkg/... $(REPO_ROOT)/test/... $(REPO_ROOT)/hack/testcluster/... $(REPO_ROOT)/apis/... $(REPO_ROOT)/controller-utils/... $(REPO_ROOT)/legacy-component-cli/... $(REPO_ROOT)/legacy-component-spec/bindings-go/...
